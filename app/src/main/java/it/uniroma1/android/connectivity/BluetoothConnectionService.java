...
import it.uniroma1.android.utils.Constants;
...
public class BluetoothConnectionService {
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            System.out.println("Socket Type: " + mSocketType + "BEGIN mAcceptThread" + this);
            ...
            while (mState != STATE_CONNECTED) {
                try {
                    ...
                    System.out.println("Socket Type: " + mSocketType + "accept() failed");
                    break;
                }
        ...
        public void cancel() {
            ...
            try {
                ...
                System.out.println("Socket Type" + mSocketType + "close() of server failed");
            }
        }
    }
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device, boolean secure) {
            ...
            try {
                ...
                System.out.println("Socket Type: " + mSocketType + "create() failed");
            }
            mmSocket = tmp;
        }
        ...
        public void cancel() {
            try {
                ...
                System.out.println("close() of connect " + mSocketType + " socket failed");
            }
        }
    }
